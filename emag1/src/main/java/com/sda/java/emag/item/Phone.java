...
public class Phone extends Item {
    ...
    public String showDetails() {
        ...
        displayResult.append(SEPARATOR);
        displayResult.append(this.getCPU());
        displayResult.append(SEPARATOR);
        displayResult.append(this.getDisplay_size());
    ...
    public <T> boolean matchCase(T input) {
        ...
        if ((Float) display_size == input) return true;
        if (brand.equals(input)) return true;
        if (CPU.equals(input)) return true;
